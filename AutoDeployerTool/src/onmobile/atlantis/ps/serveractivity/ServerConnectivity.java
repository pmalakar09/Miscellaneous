package onmobile.atlantis.ps.serveractivity;
...
public class ServerConnectivity {
     ...
     * @prasenjit password
     */
    public ServerConnectivity(String host, String userName, String password) {
        this.host = host;
    ...
    public static void main(String[] args) {
        ServerConnectivity ssh = new ServerConnectivity("10.155.10.95", "root", "password");
